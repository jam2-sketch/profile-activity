  ...
  return (
    <SafeAreaProvider>
      <SafeAreaView style={{ flex: 1 }}>
        ...
        >
          <Image
            source={require("../assets/image/ppg.jpg")}
            style={styles.profileImage}
          />

          <Text style={styles.name}>James Emman Bajao</Text>
          ...
          <View style={styles.section}>
             <Text style={styles.sectionTitle}>About</Text>
              <Text style={styles.side}>A DSSC student who likes to learn more about coding Im bad but getting somewhere</Text>
              <Text style={styles.sectionTitle}>Interests</Text>
              <Text style={styles.side}>Books and History</Text>
